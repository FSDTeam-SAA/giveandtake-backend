...
router.post('/create-resume', multer_middleware_1.upload.single('photo'), createResume_controller_1.createResume);
router.get('/get-resume', auth_middleware_1.protect, createResume_controller_1.resumeOfaUser);
router.patch('/resume/update', auth_middleware_1.protect, multer_middleware_1.upload.single('photo'), createResume_controller_1.updateResume);
